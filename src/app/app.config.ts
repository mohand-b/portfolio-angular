import {ApplicationConfig, inject, Injector, LOCALE_ID, provideAppInitializer, provideBrowserGlobalErrorListeners, provideZonelessChangeDetection, runInInjectionContext} from '@angular/core';
